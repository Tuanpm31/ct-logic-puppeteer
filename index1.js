...
(async () => {
  ...
  await page.goto('https://id.chotot.com/login/otp?phone=0812549323&continue=', { timeout: 0, waitUntil: 'domcontentloaded' });
  ...
  await inputs[4].type('7');
  await inputs[5].type('3');
